...
const About = () => {
  return (
    <section id="about" className="py-16 sm:py-20 md:py-28 lg:py-36 bg-card">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-10 sm:gap-12 lg:gap-16 items-center mb-20 sm:mb-24 md:mb-32">
            <motion.div
              ...
              {[
                {
                  ...
                  description:
                    "Clinical information is captured across clinics, hospitals, and systems — with no reliable way to follow the patient over time.",
                },
                {
                  label: "Insight",
                  title: "Lost Clinical Context",
                  description:
                    "Even when records are digitized, they rarely grow into understanding. History remains scattered instead of cumulative.",
                },
                {
                  label: "Impact",
                  title: "Decisions Without Intelligence",
                  description:
                    "When clinical data isn't structured and continuous, healthcare systems struggle to retain knowledge.",
                },
              ].map((problem, i) => (
                <motion.div
                  key={problem.title}
                ...
                >
                  ...
                  <h3 className="text-lg sm:text-xl font-serif text-foreground mb-2 leading-snug">
                    {problem.title}
                  </h3>
          ...
          <div className="grid lg:grid-cols-2 gap-10 sm:gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <h3 className="text-xl sm:text-2xl md:text-3xl font-serif text-foreground leading-tight mb-4 sm:mb-6">
